...
_OUTPUTS: dict[str, FieldSpec] = {
    ...
    "cat_ascii": (
        ...
        False,
        None,
        ParamMeta(implicit="{output_directory}/{output_filename}_cat.txt"),
    ),
    "cat_sql": (
        "File",
        False,
        None,
        ParamMeta(implicit="{output_directory}/{output_filename}_cat.sql"),
    ),
    "cat_xml": (
        "File",
        False,
        None,
        ParamMeta(implicit="{output_directory}/{output_filename}_cat.xml"),
    ),
    "cubelets": (
        "Directory",
        False,
        None,
        ParamMeta(implicit="{output_directory}/{output_filename}_cubelets"),
    ),
    "filtered": (
        "File",
        False,
        None,
        ParamMeta(implicit="{output_directory}/{output_filename}_filtered.fits"),
    ),
    "mask": (
        "File",
        False,
        None,
        ParamMeta(implicit="{output_directory}/{output_filename}_mask.fits"),
    ),
    "mask_2d": (
        "File",
        False,
        None,
        ParamMeta(implicit="{output_directory}/{output_filename}_mask-2d.fits"),
    ),
    "mask_raw": (
        "File",
        False,
    ...
    "mom2": (
        ...
        False,
        None,
        ParamMeta(implicit="{output_directory}/{output_filename}_mom2.fits"),
    ),
    "chan_map": (
        "File",
        False,
        None,
        ParamMeta(implicit="{output_directory}/{output_filename}_chan.fits"),
    ),
    "noise": (
        "File",
        False,
        None,
        ParamMeta(implicit="{output_directory}/{output_filename}_noise.fits"),
    ),
    "noise_txt": (
        "File",
        False,
        None,
        ParamMeta(implicit="{output_directory}/{output_filename}_noise.txt"),
    ),
}
