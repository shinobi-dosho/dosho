...
# pydantic BaseModels (Cab, StepRef, ...) carry a lot of inherited
# machinery; don't document it.
...
intersphinx_mapping = {
    ...
    "shinobi": ("https://stimela-ninja.readthedocs.io/en/latest/", None),
}

# -- HTML output -------------------------------------------------------------

html_theme = "furo"
html_title = f"dosho {release}"
